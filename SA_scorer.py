...
import util.formula_scorer as Scorer
...
Scorer.compute_scores(map_n_im_2_activations, 34, "(bed-X CLOSE TO (windowpane-X OR door-X))", static_thresholds[244], None)
Scorer.compute_scores(map_n_im_2_activations, 34, "(bed-X CLOSE (windowpane-X OR door-X))", static_thresholds[244], None)
