...
# ---------------------------------------------------------------------------------------------------------------------
# - Unfortunately, this code is still a mess and creating games for a real subset of neurons only may not work right. -
# - Never got around to fixing it properly.                                                                           -
# ---------------------------------------------------------------------------------------------------------------------
...
FILTERS = settings.NEURONS
ACCESS = [False for _ in settings.NEURONS]
